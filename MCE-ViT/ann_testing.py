...
feature_vector_original_test = np.load('path to data\\feature_file_name.npy')
feature_vector_processed_test = np.load('path to data\\feature_file_name.npy')
...
print("Test Label: "+ str(test_y[0:5]))
...
print("Test Label Encoded: "+ str(test_y_encoded[0:5]))


### Load best model 
model_path="path to model\\model_name.h5"
